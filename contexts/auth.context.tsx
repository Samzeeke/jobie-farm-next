...
interface AuthUserProp {
  ...
  signInWithCustomEmailAndPassword: (email: string, password: string) => Promise<any>;
...
const authUserContext = createContext<AuthUserProp>({
  ...
  loading: true,
  signOut: async () => {}, 
  signInWithCustomEmailAndPassword: async (email: string, password: string) => {}, 
  createNewUserWithEmailAndPassword: async (email: string, password: string) => {},
